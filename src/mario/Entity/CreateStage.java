...
public class CreateStage {
	...
	public void render(Graphics bufferGraphic) {
		...
		// i가 3000보다 크거나같을떄까지
		for (int i = 4250; i >= 3000; i -= 50) {
			if (i == 3950 || i == 4000 || i == 4050 || i == 4100 || i == 3600 || i == 3550 || i == 3500 || i == 3450
					|| i == 3400 || i == 3350)
				continue; // 공백만들기
			blockdelete += 50;
...
//	            list_Block.add(new Block(0, 200, 4550));
	...
	public void tower(Graphics bufferGraphic) {

		for (int i = -150; i > -3000; i -= 50) {
			list_Block.add(new Block(0, 2500, i));
		}

		for (int i = -50; i > -3000; i -= 50) {
			list_Block.add(new Block(0, 3000, i));
		}

		for (int i = 2500; i < 2700; i += 50) {
			for (int j = -200; j > -3000; j -= 500) {
				list_Block.add(new Block(0, i, j));
			}
		}
		
		for (int i = 2850; i < 3000; i += 50) {
			for (int j = -500; j > -3000; j -= 500) {
				list_Block.add(new Block(0, i, j));
			}
		}
		
		for (int i = 2500; i > 1000; i -= 50) {
			list_Block.add(new Block(0, i, -3000));
		}
